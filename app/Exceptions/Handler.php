...
class Handler extends ExceptionHandler
{
    ...
    protected $dontReport = [
        ...
        //Symfony\Component\HttpKernel\Exception\\Symfony\Component\HttpKernel\Exception\HttpException::class,
    ];
    ...
    public function report(Throwable $e)
    {
        if ($this->shouldReport($e)) {
            ...
            if (app()->bound('lern')) {
                $lernRecordEnabled = \Config::get('settings.lern_enable_record');
                $lernNotifyEnabled = \Config::get('settings.lern_enable_notify');
    ...
    {
        //Change the subject
        LERN::setSubject('['.\Config::get('settings.lern_notify_channel').']: An Exception was thrown! ('.date('D M d, Y G:i', time()).' UTC)');
