...
class AuditsController extends Controller
{
    ...
    public function index()
    {
        ...
        $purge_retention = \Config::get('settings.audit_purge_retention');

        //$audits = $this->audit->pushCriteria(new AuditByCreatedDateDescending())->paginate(20);
        $audits = AuditModel::orderBy('id', 'desc')->paginate(20);
    ...
    public function purge()
    {
        ...
        $auditsToDelete = $this->audit->where('created_at', '<', date('Y-m-d'));
