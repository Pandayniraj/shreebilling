...
class PermissionsController extends Controller
{
    ...
    public function index()
    {
        ...
        $perms = $this->permission->where(function ($query) {
            $terms = \Request::get('term');
            if ($terms) {
                return $query->where('name', 'LIKE', '%' . $terms . '%')
                    ->orWhere('display_name', 'LIKE', '%' . $terms . '%');
            }
        })
    ...
    public function getModalDelete($id)
    {
        ...
        $modal_route = route('admin.permissions.delete', ['permissionId' => $permission->id]);
    ...
    public function generate()
    {
        ...
        foreach ($routes as $route) {
            ...
            if (null == $this->permission->where('name', $name)->first()) {
