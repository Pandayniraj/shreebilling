...
class WalledGarden
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $walled_garden_enabled = \Config::get('settings.walled-garden_enabled');
        $exemptionPath = \Config::get('settings.walled-garden_exemptions-path');
        $exemptionsRegEx = \Config::get('settings.walled-garden_exemptions-regex');
