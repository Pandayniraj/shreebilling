 ...
 */
namespace App\Libraries\Talk;

use Illuminate\Contracts\Config\Repository;
use App\Libraries\Talk\Conversations\Conversation  as ConversationRepository;
use App\Libraries\Talk\Messages\Message as MessageRepository;
...
class Talk
{
   ...
   protected function getSerializeUser($user1, $user2)
    ...
    public function getMessagesByUserIdLatest($userId, $offset = 0, $take = 20)
    {
        return $this->getConversationsByUserId($userId, $offset, $take);
    }
