...
class MenuBuilderManager
{
    ...
    private function instantiateHandler($menuHandlerName = null)
    {
        ...
        if (null == $menuHandlerName) {
            ...
            $menuHandlerName = \Config::get('settings.menu-builder_framework_handler');
        ...
        if ('erp3' == $menuHandlerName) {
            // Get the menu handler class name from the config.
            $menuHandlerName = \Config::get('settings.menu-builder_framework_handler_erp3');
