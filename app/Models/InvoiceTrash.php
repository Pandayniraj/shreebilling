...
class InvoiceTrash extends Model
{
    /**
     * @var array
     */
    protected $table = 'invoice_trash';
    ...
    protected $fillable = [
        ...
        'comment', 'org_id', 'customer_pan', 'tax_amount', 'terms', 'taxable_amount', 'bill_no', 'fiscal_year', 'is_renewal', 'fiscal_year_id', 'from_stock_location', 'entry_id','outlet_id','delete_by'
    ];
