...
class Role extends Model
{
    ...
    {
        return $this->belongsToMany(Config::get('entrust.models.permission'), Config::get('entrust.tables.permission_role_table'), Config::get('entrust.foreign_keys.role'), Config::get('entrust.foreign_keys.permission'));
    }
        ...
        public function savePermissions($inputPermissions)
    {
        ...
        if (\Cache::getStore() instanceof TaggableStore) {
            \Cache::tags(Config::get('entrust.tables.permission_role_table'))->flush();
        }
    }
}
