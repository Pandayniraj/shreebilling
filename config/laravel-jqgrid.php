...
return [
    ...
    */
    ...
    'default_grid_options' => ['datatype' => 'json', 'mtype'  =>  'POST', 'treeGridModel' => 'adjacency'],
    ...
    */
    ...
    'default_pivot_grid_options' => ['yDimension' => []],
    ...
    */
    ...
    'default_group_header_options' => ['useColSpanStyle' => true],
    ...
    */
    ...
    'default_col_model_properties' => ['searchoptions' => ['sopt'=>['cn']]],
    ...
    */
    ...
    'default_navigator_options' => ['add' => false, 'edit' => false, 'del' => false, 'search' => false, 'view' => true, 'refresh' => false],
    ...
    */
    ...
    'default_filter_toolbar_options' => ['stringResult' => true],
    ...
    */
    ...
    'default_filter_toolbar_buttons_options' => ['filterToolbar' => false, 'toggleButton' => true, 'clearButton' => true, 'toggleButtonText' => '', 'clearButtonText' => ''],
    ...
    */
    ...
    'default_export_buttons_options' => ['xlsButtonVisible' => true, 'xlsButtonText' => 'xls', 'xlsIcon' => 'ui-icon-arrowthickstop-1-s', 'csvButtonVisible' => true, 'csvButtonText' => 'csv', 'csvIcon' => 'ui-icon-arrowthickstop-1-s'],
    ...
    */
    ...
    'pivot_options' => ['aggregates', 'colTotals', 'frozenStaticCols', 'groupSummary', 'groupSummaryPos', 'rowTotals', 'rowTotalsText', 'xDimension', 'yDimension'],
    ...
    */
    ...
    'group_header_options' => ['useColSpanStyle', 'groupHeaders'],
    ...
    */
    ...
    'function_type_properties' => [
                        'datatype' => ['xml', 'xmlstring', 'json', 'jsonstring', 'local', 'javascript', 'clientSide'],
                        'cellattr' => [],
                        'formatter' => ['integer', 'number', 'currency', 'date', 'email', 'link', 'showlink', 'checkbox', 'select', 'actions'],
                        'unformat' => [],
                        'sorttype' => ['int', 'integer', 'float', 'number', 'currency', 'date', 'text'],
                        'unformat' => [],
                        'dataInit' => [],
                        'fn' => [],
                        'custom_element' => [],
