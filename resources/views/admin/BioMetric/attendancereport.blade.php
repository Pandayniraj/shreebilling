    ...
    <div class="col-sm-12">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                <form id="attendance-form" role="form" enctype="multipart/form-data" action="attendancereport" method="post" class="form-horizontal form-groups-bordered">
                    {{ csrf_field() }}
                ...
                <table id="" class="table table-bordered std_table">
                    ...
                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <?php
                                 $userAtt = \TaskHelper::getBiometricUserAttendance($av->machine_userid, $date_in); ?>
                            
                                <td style="width: 100%" class="col-sm-3">{{ $av->name }}</td>
                                @for($i=1; $i< 32; $i++)
                                    <?php $data = '<td></td>'; ?>
                                    ...
                                    @else
                                        ...
                                        @if(!$holidayFlag)
                                            ...
                                            <?php  $checkPresent =  \Carbon\Carbon::parse($uv->datetime)->format('y-m-d'); ?>
                                @if(strtotime($checkPresent) == strtotime($date_in.'-'.$i))
