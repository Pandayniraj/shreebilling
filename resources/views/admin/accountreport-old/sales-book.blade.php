...
<div class="btn-group btn-xs pull-right">
    ...
    <a href="{{$url}}op=pdf" target="_blank" class="btn btn-success btn-xs"> <i class ="fa fa-download"></i> Pdf
    </a>&nbsp;&nbsp;
      <a href="{{$url}}op=excel"  class="btn btn-primary btn-xs"><i class ="fa fa-download"> </i> Excel</a>&nbsp;&nbsp;
      <a href="{{$url}}op=print"  class="btn btn-primary btn-xs"><i class ="fa fa-print"></i> Print</a>&nbsp;&nbsp;
    ...
    <div class="box-header with-border">
        ...
        <div class="col-md-2">
           ...
           <div class="input-group">
            ...
            <a href="/admin/sales-book/" class="btn btn-success btn-sm" id='btn-filter-clear'>Reset</a>
            </div>
...
<tr>
    ...
    <td>{{number_format($sal_bks->total_amount,2)}}</td>
    <td></td>
    <td></td>
    <td>{{number_format($sal_bks->discount_amount,2)}}</td>
    <td>{{number_format($sal_bks->taxable_amount,2)}}</td>
 <td>{{number_format($sal_bks->tax_amount,2)}}</td>
</tr>
 <?php
      ...
      $tax_amount = $tax_amount +  $sal_bks->tax_amount;
       ...
       $discount_amount = $discount_amount +  $sal_bks->discount_amount;
    ?>
...
<div class="center">
    ...
    {!! $sales_book?$sales_book->appends(\Request::except('page'))->render():'' !!}
