...
{{--     </tr>--}}
     <tr><td colspan="12"></td></tr>
        ...
        <tr >
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Date</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Miti</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Ref.</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Bill No.</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;width: 20%">Description</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;width: 20%">Narration</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Cheque No.</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Type</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Tag</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Dr Amount</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Cr Amount</th>
            <th style="border:1px solid;font-weight:bold;background-color:#dd4b39;">Balance</th>
        </tr>
     </thead>
    <tbody>
    ...
    @endforeach
              <tr>
                <th colspan="9" style="text-align: right;font-weight:bold;background-color:#dd4b39;">Total</th>
                  <th style="font-weight:bold;background-color:#dd4b39;">{{round($dr_total,2)}}</th>
                  <th style="font-weight:bold;background-color:#dd4b39;">{{round($cr_total,2)}}</th>
                <td style="background-color: #dd4b39;font-weight: bold">@if($entry_balance['dc']=='D') Dr @else Cr @endif {{ round($entry_balance['amount'],2)}}</td>
              </tr>
    </tbody>
  </table>
