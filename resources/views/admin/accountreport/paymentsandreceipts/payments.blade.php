                        ...
                        <div class="row" style="display: flex">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="ReportStartdate" type="text" name="startdate" class="form-control input-sm datepicker" value="{{$startdate?$startdate:$fiscal->start_date}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="ReportEnddate" type="text" name="enddate" class="form-control input-sm datepicker"
                                               value="{{$enddate?$enddate:$fiscal->end_date}}">
                                        <div class="input-group-addon">
                                            <i>
                            ...
                            <div style="margin-left: 10px">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="/admin/payment-report?startdate={{$startdate}}&enddate={{$enddate}}&export=true&type={{Request::get('type')}}&fiscal_year={{$fiscal_year}}"
                                       class="btn btn-success btn-sm" id="btn-filter-clear">
                                        <i class="fa file-export"></i> Export
                                    </a>
                                </div>
                            </div>
                        </div>
...
{{--                        <th>Entry Source</th>--}}
                ...
                <tbody id='entry_list' style="font-size: 12px;">
                <?php
                    $total=0
                ?>
                   @foreach($entryitems as $ei)
                        <tr><td><a href="/admin/entries/show/{{$ei->dynamicEntry()->entrytype->label}}/{{$ei->dynamicEntry()->id}}">{{$ei->dynamicEntry()->number}}</a></td>
                            <td style="white-space: nowrap;">{{$ei->dynamicEntry()->date}}
...
{{--                            </td>--}}
                            ...
                            <td>
                                <a href="#" class="tip">{{ $ei->dynamicEntry()->currency}} {{number_format($ei->amount,2)}}
