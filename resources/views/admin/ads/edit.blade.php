                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                ...
                                placeholder="Name" required="" value="{{$ads->name}}">
                     ...
                     <div class="row">
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="file" name="attachment" class="form-control" placeholder="attachment" required=""  accept="image/*">
                                <div class="input-group-addon">
                      ...
                      <div class="row">
                        <div class="col-md-4 col-sm-12 form-group">
                            <div class="input-group">
                                ...
                                <input type="checkbox" name="enabled" @if($ads->enabled) checked="" @endif>
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <img src="/ads/{{ $ads->attachment }}"  style="height: 300px;width: 300px;margin-left: 20px;">
                    </div>
                    <br>
