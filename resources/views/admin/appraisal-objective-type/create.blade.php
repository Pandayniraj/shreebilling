...
<div class='row'>
	<div class='col-md-12'>
		<div class="box">
			<div class="box-body">
				<form action="/admin/appraisal/objective-types/store" method="post">
							...
							<div class="col-md-12">
								<div class="form-group">  
									...
									<div class="input-group">
										...
										<input type="text" name="name" id="" value="{{ old('name') }}" placeholder="Objective Type Name" class="form-control " required="required"> 
							...
							<div class="col-md-6">
								<div class="form-group">  
									...
									<div class="input-group">
										...
										<input type="number" name="points" id="" value="{{ old('points') }}" placeholder="Total Points" class="form-control" max="100" min="5" required="required"> 
										<div class="input-group-addon">
											<a href="#"><i class="fa fa-info-circle"></i></a>
										</div>
									</div>
							...
							<div class="col-md-12">
								<div class="col-md-2" style="padding-left: 0;"> 
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="is_master" value="master" id="is_master" checked>
								...
								<div class="col-md-6 appraisal_template" style="display:none;"> 
									<label class="control-label">Apprisal Template: <span class="text-danger">*</span></label>
					                  <div class="input-group" style="display:inline-flex;">
						                  <select class="form-control searchable" id="appraisal_template" name="appraisal_template">
