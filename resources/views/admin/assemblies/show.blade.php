    ...
    <div class='row'>
        ...
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <span class="pull-right">
              <span>Assembly</span>
               <a href="/admin/assembly/print/{{ $ord->id }}" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>

               <a href="/admin/assembly">
          ...
          &nbsp;
          <a href="/admin/assembly/pdf/{{ $ord->id }}">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <strong>Product: {{ $ord->productname->name }}</strong><br>
             Source: {!! $ord->sourcename->location_name !!}<br/>
             Destination: {!! $ord->destinationname->location_name !!}<br/>
            Assembled Quantity: {!! $ord->assembled_quantity  !!}
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <b>Assemble By:</b> {{ date("d/M/Y", strtotime($ord->assemble_by )) }}<br>
          <b>Status:</b> {{ ucwords($ord->status) }}<br>
          <b>Total Cost:</b> {{ $ord->total_cost }}<br>
