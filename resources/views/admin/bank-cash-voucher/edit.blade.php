...
<div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class=""><strong>{{ ucfirst(Request::segment(4)) }}</strong> Bank and Cash Voucher  #{{ request()->segment(5)}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                    	<div class="form-group">
	                    	<label for="tag_id">Cheque No</label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-stripped table-responsive table-hover table-bordered">
                                    ...
                                    <tr class="bg-success">
                                        ...
                                        <th style="width: 14%">Ledger</th>
                                        <th style="width: 12%; white-space: nowrap;">Dr Amount</th>
                                        <th style="width: 12%; white-space: nowrap;">Cr Amount</th>
                                            ...
                                            <tr id='{{rand(1,1000).time()}}' class="edit-legders">
                                                ...
                                                {{-- <td>
                                                    <select class="form-control" name="assign_to[]">
                                                        ...
                                                        @foreach( $users as $user)
                                                            <option value="{{ $user->id }}" {{ ($entryitem->assign_to == $user->id)? 'selected' : '' }}>{{ $user->first_name.' '.$user->last_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td> --}}
