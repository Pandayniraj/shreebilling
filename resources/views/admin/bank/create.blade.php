                ...
                <form method="post" action="{{ route('admin.bank.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                         ...
                         <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="routing_number" placeholder="Routing Number" class="form-control">
                                <div class="input-group-addon">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                <textarea name="description" placeholder="Account Descriptions" class="form-control"></textarea>
                                <div class="input-group-addon">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                    <button type="submit" class="btn btn-primary" id='btn-submit-edit'>Create Account</button>
