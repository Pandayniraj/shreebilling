        ...
        <div class='col-md-12'>
            <div class="box-body">
                ...
                <div class="col-md-12">
                        ...
                        <form method="POST" action="/admin/billofmaterials">
                            {{ csrf_field() }}
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                          <label>Product</label>
                                          <input type="text" class="form-control pull-right" name="product" value="" id="product_name" required="">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                      <div class="form-group">
                                          <div class="checkbox"> 
                                              <label>
                                                  ...
                                                  {!! Form::checkbox('auto_assemble', '1', null) !!} Can Auto Assemble
                                              </label>
                                          </div>
                                      </div>  
                                    </div>
                                      ...
                                      <div class="form-group">
                                          <div class="checkbox"> 
                                              <label>
                                                  ...
                                                  {!! Form::checkbox('auto_disassemble', '1',null) !!} Can Auto Disassemble
                                              </label>
                                          </div>
                                      </div>  
                                    </div>
                                     ...
                                     <div class="col-md-3">
                                          <label>Status</label>
                                           {!! Form::select('status', ['parked'=>'Parked','completed'=>'Completed'], $course->status ,['class'=>'form-control']) !!}
                                    </div>
