        ...
        <div class='col-md-12'>
            <div class="box-body">
                ...
                <div class="col-md-12">
                        ...
                        <form method="POST" action="/admin/billofmaterials/{{$billofmaterials->id}}">
                            {{ csrf_field() }}
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                          <label>Product</label>
                                          <input type="text" class="form-control pull-right" name="product" value="{{$billofmaterials->productname->name}}" id="product_name" required="" readonly>
                                    ...
                                    <div class="col-md-3">
                                      <div class="form-group">
                                          <div class="checkbox"> 
                                              <label>
                                                  {!! '<input type="hidden" name="auto_assemble" value="0">' !!}
                                                  {!! Form::checkbox('auto_assemble', '1', $billofmaterials->auto_assemble) !!} Can Auto Assemble
                                              </label>
                                          </div>
                                      </div>  
                                    </div>
                                     ...
                                     <div class="col-md-3">
                                      <div class="form-group">
                                          <div class="checkbox"> 
                                              <label>
                                                  {!! '<input type="hidden" name="auto_disassemble" value="0">' !!}
                                                  {!! Form::checkbox('auto_disassemble', '1', $billofmaterials->auto_disassemble) !!} Can Auto Disassemble
                                              </label>
                                          </div>
                                      </div>  
                                    </div>
                                     ...
                                     <div class="col-md-3">
                                          <label>Status</label>
                                           {!! Form::select('status', ['parked'=>'Parked','completed'=>'Completed'], $billofmaterials->status ,['class'=>'form-control']) !!}
                                    </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <div class="checkbox"> 
                                              <label>
                                                  {!! '<input type="hidden" name="obsolete" value="0">' !!}
                                                  {!! Form::checkbox('obsolete', '1', $billofmaterials->obsolete) !!} Obsolete
                                              </label>
                                          </div>
                                      </div>  
                                    </div>
                             ...
                             <hr/>
                                <table class="table table-striped">
                                    <thead>
                                     ...
                                     <tbody>
                                      @foreach($billofmaterials_details as $bd)
                                      <tr>  
                                          <td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td id="total">{{$billofmaterials->total_amount}}</td>
                                            <td>
                                                <input type="hidden" name="total_tax_amount" id="total_tax_amount" value="{{$billofmaterials->total_amount}}">
                                                <input type="hidden" name="final_total" id="total_" value="{{$billofmaterials->total_amount}}">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div class="col-md-6 form-group" style="margin-top:5px;">
                                    ...
                                    <textarea class="form-control TextBox comment" name="comments" id="comments">{{$billofmaterials->comments}}</textarea>
                                </div>
   ...
   $('#product_name').on('change',function(){
         ...
         var product_name = $('#product_name').val();
            ...
            $("#component_product").autocomplete({
                ...
                source: "/admin/getComponentProduct?product_name="+ $('#product_name').val(),  
    ...
    $(document).on('click', '#addcomponentproduct', function() {
      ...
      var  wastage_qty  = $('#wastage_qty').val();
         ...
         $.ajax(
            {
             url: "/admin/getComponentProductInfo",  
