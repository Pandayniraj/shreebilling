...
#bg-text
{
    ...
    <header class="clearfix">
      ...
      <div id="details" class="clearfix">
        ...
        <div id="client">
          <div class=""><strong>Product: {{ $billofmaterials->productname->name }}</strong></div>
          <div class=""> Can Auto Assemble: {!! $billofmaterials->auto_assemble !!}</div>
          <div class="">Can Auto Disassemble: {!! $billofmaterials->auto_disassemble !!}</div>
          <div class="">Obsolete: {!! $billofmaterials->obsolete  !!}</div>
      ...
      <TD width="50%" style="text-align: right">
        <div id="invoice">
          <div class="date">Bill Date:{{ date("d/M/Y", strtotime($billofmaterials->bill_date )) }}</div>
          <div class="date">Status: {{ $billofmaterials->status }}</div>
    ...
    <!-- /.row -->
      ...
      <div id="notices">
        <div>Note:</div>
        <div class="notice"> {!! nl2br($billofmaterials->comments) !!}</div>
      </div>
