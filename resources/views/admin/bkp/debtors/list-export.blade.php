...
<table >
    ...
    <tr class="bg-primary">
        ...
        <th colspan="2" style="border:1px solid;font-weight:bold;width: 12%;text-align: center">Customer Code</th>
        <th colspan="5" style="border:1px solid;font-weight: bold;">Customer Name</th>
        <th colspan="2" style="border:1px solid;font-weight: bold;width: 10%;text-align: center">Opening B/c(DR)</th>
        <th colspan="2" style="border:1px solid;font-weight: bold;width: 10%;text-align: center">Opening B/c(CR)</th>
        <th colspan="2" style="border:1px solid;font-weight:bold;width: 12%;text-align: center">Debit Amt</th>
        <th colspan="2" style="border:1px solid;font-weight:bold;width: 12%;text-align: center">Credit Amt</th>
        <th colspan="2" style="border:1px solid;font-weight:bold;width: 12%;text-align: center">Closing B/c</th>
    </tr>
    </thead>
    <tbody>
    @foreach($data as $key=>$entries)
        ...
        <tr>
            ...
            <td colspan="2" style="border:1px solid;text-align: center">{{ $entries['code']  }}</td>
