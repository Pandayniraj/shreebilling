...
@section('content')
     ...
     <div class='row'>
       <div class='col-md-12'>
          <div class="box">
             <div class="box-body ">
                <form method="post" action="/admin/casescategory/{{$edit->id}}/update" enctype="multipart/form-data">  
                {{ csrf_field() }}                 
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="name" placeholder="Name" id="name" value="{{$edit->name}}" class="form-control" >
                    </div>
