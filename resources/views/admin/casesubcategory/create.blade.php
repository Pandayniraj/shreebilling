...
@section('content')
     ...
     <div class='row'>
       <div class='col-md-12'>
          <div class="box">
		     <div class="box-body ">
		     	<form method="post" action="/admin/casessubcategory/store" enctype="multipart/form-data">  
		     	{{ csrf_field() }}                 
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="name" placeholder="Sub Category Name" id="name" value="" class="form-control" >
                    </div>

                    <div class="col-md-4">
                        <label class="control-label">Subject</label>
                        <input type="text" name="subject" placeholder="Subject" id="name" value="" class="form-control" >
                    </div>
                </div> 
