        ...
        <form method="post" action="{{route('admin.chalani.edit',$chalani->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="date" class="form-control input-sm datepicker" placeholder="Date..." required="" value="{{$chalani->date}}">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="letter_num" class="form-control  input-sm" placeholder="Letter Number..." value="{{$chalani->letter_num}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="letter_date" class="form-control  input-sm datepicker" placeholder="Letter Date..." value="{{$chalani->letter_date}}">
                      <div class="input-group-addon">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="subject" class="form-control  input-sm" placeholder="Subject..." required="" value="{{$chalani->subject}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                         <input type="text" name="receiver_org" class="form-control  input-sm" placeholder="Receiver Organization..."  value="{{$chalani->receiver_org}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('ticket_id',$tickets,$chalani->ticket_id,['class'=>'form-control searchable','placeholder'=>'Select Ticket Number']) !!}
                      <div class="input-group-addon">
            ...
            <div class="row">
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="remarks" class="form-control  input-sm" placeholder="Remarks..." value="{{$chalani->remarks}}">
                      <div class="input-group-addon">
