 <table class="table table-bordered">
     <thead>
        <tr><th  style="background-color:#F2BB66;" colspan="8" align="center"><b>Company PAN: {{$pan}}<b></th></tr>
        <tr><th style="background-color: #89C35C;"colspan="8" align="center"><b>Company Address:  {{$address}}</b></th></tr>
        <tr><th style="background-color: #F2BB66;" colspan="8" align="center"><b>Company Name: {{$name}}</b></th></tr>
        <tr><th style="background-color: #89C35C;" colspan="8" align="center"><b>Balance Statement From : {{$start_date}} To {{$end_date}} </b></th></tr>

         <tr>
          <th colspan="7" style="background-color:#1b95ff;">Current opening balance</th>
    ...
    <tbody>
              ...
              @endforeach
              <tr>
                <td colspan="7" style="background-color: #1b95ff;">Current closing balance</td>
