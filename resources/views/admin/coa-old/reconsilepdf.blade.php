...
footer {
  ...
  ?>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            <th class="no">Created Date</th>
            <th class="no">Reconcile Date</th>
            <th class="no">No</th>
            <th class="no">Description</th>
            <th class="no">Entry Type</th>
            <th class="no">Tag</th>
            <th class="no">Dr.({{env(APP_CURRENCY)}})</th>
            <th class="no">Cr.({{env(APP_CURRENCY)}})</th>
        ...
        <tbody>
         ...
         <?php
          ...
          <tr>
            <td colspan="8">Current closing balance</td>
            <td>@if($entry_balance['dc']=='D') Dr @else Cr @endif {{ number_format($entry_balance['amount'],2)}}</td>
          </tr>
