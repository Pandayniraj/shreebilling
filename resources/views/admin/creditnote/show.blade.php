    ...
    <div class='row'>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <span class="pull-right">
              <span>Tax Invoice</span>
               <a href="/admin/creditnote/print/{{ $ord->id }}" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>

               <a href="/admin/creditnote">
          ...
          &nbsp;
          <a href="/admin/creditnote/generatePDF/{{ $ord->id }}">
      ...
      <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <b>{{ ucwords(str_replace("_", " ", ucfirst($ord->order_type)))}} #MN{{ $ord->id }}</b><br>
