        ...
        <form method="post" action="{{route('admin.darta.create')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="darta_num" class="form-control input-sm" placeholder="Darta Number..." required="">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="received_letter_num" class="form-control  input-sm" placeholder="Received Letter Number...">
                      <div class="input-group-addon">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('sender_office_name',$users,null,['class'=>'form-control searchable','placeholder'=>'Select Sending Officer']) !!}
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('receiving_officer_name',$users,null,['class'=>'form-control searchable','placeholder'=>'Select Receiving Officer']) !!}
                      <div class="input-group-addon">
            ...
            <div class="row">
                  <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="received_date" class="form-control input-sm datepicker" placeholder="Received Date...">
                      <div class="input-group-addon">
