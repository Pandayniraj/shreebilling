       		...
       		<table class="table table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('admin/darta/general.columns.id') }}</th>
                        <th>{{ trans('admin/darta/general.columns.darta_number') }}</th>
                        <th>{{ trans('admin/darta/general.columns.subject') }}</th>
                        <th>{{ trans('admin/darta/general.columns.received_letter_number') }}</th>
                        <th>{{ trans('admin/darta/general.columns.letter_date') }}</th>
                        <th>{{ trans('admin/darta/general.columns.received_date') }}</th>
                        <th>{{ trans('admin/darta/general.columns.action') }}</th>
