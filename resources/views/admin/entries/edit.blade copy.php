								    ...
								    @if (isset($entriesitem) ) 
								     @foreach ($entriesitem as $row => $entryitem)
								      <tr id='{{rand(1,1000).time()}}' class="edit-legders">
	                                        ...
	                                        @if($entryitem->dc == 'D')
	                                        <td><input type="number" step="any" name="dr_amount[]" value="{{$entryitem->amount}}" class="form-control dr-item line-amounts input-sm" ></td>
	                                        <td><strong>-</strong></td>
	                                        @else
	                                         <td><strong>-</strong></td>
	                                         <td><input type="text" name="dr_amount[]" value="{{$entryitem->amount}}"  class="form-control cr-item line-amounts input-sm"></td>
	                                        @endif
