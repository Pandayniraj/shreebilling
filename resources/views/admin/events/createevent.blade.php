                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="text" class="form-control event_start_date" value="{{ isset($event_start_date) ? $event_start_date : '' }}" name="event_start_date" id="event_start_date" required="">
                                    <div class="input-group-addon">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="text" class="form-control event_end_date" value="{{ isset($event_end_date) ? $event_end_date : '' }}" name="event_end_date" id="event_end_date" required="">
                                    <div class="input-group-addon">
                                        <a href="#"><i class="fa fa-calendar"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="number" name="num_participants" placeholder="Participants num" id="num_participants" class="form-control">
                                    <div class="input-group-addon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="text" name="menu_items" placeholder="Menu items" id="menu_items" class="form-control">
                                    <div class="input-group-addon">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="text" name="other_details" placeholder="Other Details" id="other_details" class="form-control">
                                    <div class="input-group-addon">
