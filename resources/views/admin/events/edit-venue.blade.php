...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class="box">
                <div class="box-body">
                    {!! Form::open( ['route' => ['edit-venue',$edit->id], 'class' => 'form-horizontal'] ) !!}
                ...
                <div class="content col-md-9">
                  ...
                  <div class="row">
                       ...
                       <div class="input-group ">
                        <input type="text" name="venue_name" placeholder="Enter venue name" id="company_id" class="form-control" required value="{{$edit->venue_name}}">
                    ...
                    <div class="row">
                       ...
                       <div class="input-group ">
                        <textarea class="form-control" name="venue_facilities" id="comments" placeholder="Write Description" cols="120">{{$edit->venue_facilities}}</textarea>
                        </div>
                        </div>
                        </div>
                       ...
                       <div class="input-group ">
                        <textarea class="form-control" name="other_details" id="comments" placeholder="Write Description" cols="120">{{$edit->other_details}}</textarea>
                        </div>
                        </div>
                        </div>
                        <div class="col-md-12">
                          <br>
                    <div class="form-group">
                        <button class="btn btn-primary" id="btn-submit-edit" type="submit">Update Venues</button>
