...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body ">
                <form method="post" action="{{route('admin.expense.sof.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input  name="year" class="form-control yearpicker" placeholder="Year" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa   fa-database"></i></a>
                                </div>
                            </div>
