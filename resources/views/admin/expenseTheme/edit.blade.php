...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body ">
                <form method="post" action="{{route('admin.expense.theme.update',$theme->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="input-group">
                                <select name="sector_id" class="form-control select2 " style="width: 347px;">
                                    ...
                                    @foreach($sectors as $sector)
                                        <option value="{{ $sector->id }}" {{ $sector->id == $theme->sector->id ? 'selected' : '' }}>{{$sector->name}}</option>>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="name" class="form-control" placeholder="Name" required="" value="{{$theme->name}}">
