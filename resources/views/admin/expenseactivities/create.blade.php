...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body ">
                <form method="post" action="{{route('admin.expense.activities.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="input-group">
                                <select name="pa_activity_id" class="form-control select2 " style="width: 527px;">
                                    ...
                                    @foreach($expensePa as $expensePa)
                                        <option value="{{$expensePa->id}}">{{$expensePa->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="number" name="rr_budget" class="form-control" placeholder="RR Budget" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa   fa-database"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="number" name="poa_budget" class="form-control" placeholder="Poa Budget" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa   fa-database"></i></a>
                                </div>
                            </div>
