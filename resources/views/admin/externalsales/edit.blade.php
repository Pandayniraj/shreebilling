    ...
    <div class='col-md-12'>
        <div class="box-body">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                    <form method="POST" action="{{route('admin.externalsales.update',$invoice->id)}}" id="myinvoiceform">
                        {{ csrf_field() }}
                        ...
                        <div class="">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control input-sm pull-right" name="customer_id" value="{{$invoice->client_name}}" required="">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            <div class="hide_on_tablet">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            {!! Form::label('termsbill_no', 'Quotation No.') !!}
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clone"></i>
                                                </div>
                                                {!! Form::number('bill_no',$invoice->bill_no, ['class' => 'form-control input-sm','min'=>1,'readonly'=>'readonly']) !!}
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 form-group" style="">
                                        ...
                                        <input type="text" name="from_stock_location" value="{{$invoice->from_stock_location}}" class="form-control input-sm input-sm">
                                    </div>
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td id="sub-total">{{ number_format($invoice->total_amount,2) }}</td>
                                        <td>&nbsp; <input type="hidden" name="subtotal" id="subtotal" value="{{ number_format($invoice->total_amount,2) }}"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td id="non-taxable-amount">@if($invoice->tax_amount>0) 0 @else{{number_format($invoice->total_amount,2)}} @endif</td>
                                        <td>&nbsp;<input type="hidden" name="non_taxable_amount"
                                            id="nontaxableamount" value="@if($invoice->tax_amount>0) 0 @else{{number_format($invoice->total_amount,2)}}@endif">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" style="text-align: right;">Taxable Amount</td>
                                        <td id="taxable-amount">{{ number_format($invoice->taxable_amount,2) }}</td>
                                        <td>&nbsp; <input type="hidden" name="taxable_amount" id="taxableamount" value="{{  number_format($invoice->taxable_amount,2) }}"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" style="text-align: right;">Tax Amount (13%)</td>
                                        <td id="taxable-tax">{{ number_format($invoice->tax_amount,2) }}</td>
                                        <td>&nbsp; <input type="hidden" name="taxable_tax" id="taxabletax" value="{{  number_format($invoice->tax_amount,2) }}"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" style="text-align: right; font-weight: bold;font-size: 16px">Total Amount ({{ env('APP_CURRENCY')}}) </td>
                                        <td style="font-size: 16px;font-weight: bold;" id="total">{{ number_format($invoice->total_amount,2) }}</td>
                                        <td>
                                            <input type="hidden" name="total_tax_amount" id="total_tax_amount" value="{{  number_format($invoice->tax_amount,2) }}">
                                            <input type="hidden" name="final_total" id="total_" value="{{  number_format($invoice->total_amount,2) }}">
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
