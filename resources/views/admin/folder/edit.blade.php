                     ...
                     <div class="col-md-4 col-sm-12 form-group">
                      <label class="control-label">Folder Name</label>
                        <div class="input-group">
                          <input type="text" name="name" class="form-control" placeholder="Folder Name" required="" value="{{ $folder->name }}">
                 ...
                 <div class="row">
                     <div class="col-md-4 col-sm-12 form-group">
                      <label class="control-label">Folder Descriptions</label>
                        <div class="input-group">
                          <textarea  name="description" class="form-control" placeholder="Folder Descriptions">
                            {{ $folder->description }}
                          </textarea>
                          <div class="input-group-addon">
                 ...
                 <div class="row">
                     <div class="col-md-4 col-sm-12 form-group">
                      <label class="control-label">Shared Users</label>
                          ...
                          {!!  Form::select('shared_user[]',$users,json_decode($folder->shared_user),['class'=>'form-control','id'=>'shared_user',"multiple"=>"multiple"])  !!}
