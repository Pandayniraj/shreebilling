...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
    ...
    <p>
       ...
       All Deleted business invoices  are here

    </p>
    <a class="btn btn-default btn-xs" href="/admin/invoice1">Back to Tax invoice</a>
        ...
        <div class="box ">
            <div class="box-header">
              ...
              <div class="wrap" style="margin-top: 5px;">
                        <form method="get" action="/admin/invoicetrash">
                    <div class="filter form-inline" style="">
                        ...
                        <a href="/admin/invoicetrash" class="btn btn-sm btn-default" id="btn-filter-clear" >
