...
<script src="{{ asset("/bower_components/intl-tel-input/build/js/intlTelInput-jquery.min.js") }}"></script>
    ...
    <div class='row'>
        ...
        <div class="box-body">
                  ...
                  <form method="post" action="{{ route('admin.lead.query-create', $lead_id) }}">
                    {{ csrf_field() }}
         ...
         <h4> New Query </h4>
                ...
                <label class="control-label col-sm-4">Main Product</label>
                    <div class="input-group ">
                         {!! Form::select('product', $products, null, ['class' => 'form-control select2','id'=>'products']) !!}
                ...
                <label class="control-label col-sm-4">Price</label>
                    <div class="input-group ">
                        <input type="text" name="price" id="airline" value="" class="form-control input-sm">
                        <div class="input-group-addon">
                ...
                <label class="control-label col-sm-4">Phone</label>
                    <div class="input-group ">
                        <input type="text" name="phone" placeholder="" id="phone" value="" class="form-control input-sm">
                        <div class="input-group-addon">
                ...
                <label class="control-label col-sm-4">Contact Person</label>
                    <div class="input-group ">
                        <input type="text" name="contact_person" id="contact_person" value="" class="form-control input-sm">
                        <div class="input-group-addon">
                ...
                <div class="col-md-6">
                          <label class="control-label col-sm-4">Detail</label>
                           <div class="input-group ">
                          <textarea class="form-control" name="detail" id="detail" placeholder="Write Description">{!! \Request::old('description') !!}</textarea>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                             ...
                             <label class="control-label col-sm-4">Next Action Date</label>
                               <div class="input-group ">
                                <input type="text" name="next_action_date" id="next_action_date" value="" class="form-control input-sm datepicker">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa fa-user"></i></a>
                                </div>
                               </div>
                         ...
                         <div class="col-md-6">
                             ...
                             <label class="control-label col-sm-4">Status</label>
                               <div class="input-group ">
                                {!! Form::select('status', ['New'=>'New','Follow Up'=>'Follow Up','Closed'=>'Closed'], null, ['class' => 'form-control select2','id'=>'products']) !!}
                               </div>
                          </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="InputsWrapper">
                       <div> 
                          <input type="text" class="form-control" name="paxName[]" id="field_1" value="" placeholder="Product">
                          <input type="text" class="form-control" name="mileageCard[]" id="field_1" value="" placeholder="Quantity">
