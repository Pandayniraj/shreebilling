                ...
                <div class="box-body">
                    {!! Form::open( ['route' => 'admin.menus.save', 'id' => 'form_save_menu'] ) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('label', null, ['class' => 'form-control','placeholder'=>'Enter Label For English Language']) !!}
                        </div>

                        <div class="form-group">
                            <button class="btn btn-xs btn-primary" type="button" id='flip-lang'> <span class="icon"><i class="fa fa-angle-double-down"></i></span> More Language </button>
                        </div>
                        <div style="display: none" id='more-lang'>
                         <div class="form-group">
                            {!! Form::label('label', 'Nepali|नेपाली ') !!}
                            {!! Form::text('nepali_label', null, ['class' => 'form-control','placeholder'=>'Enter Label For Nepali Language','id'=>'nepali_label']) !!}
                        </div>
                         <div class="form-group">
                            {!! Form::label('label', 'Spanish|español' ) !!}
                            {!! Form::text('spanish_label', null, ['class' => 'form-control','placeholder'=>'Enter Label For Spanish Language','id'=>'spanish_label']) !!}
                        </div>
                    </div>
...
@section('body_bottom')
    ...
    <script language="JavaScript">
        $('#jstree_menu_div').on("select_node.jstree", function (e, nodeSelected) {
            ...
            var urlShowRoute = '{!! route("admin.menus.get-data",":id") !!}'.replace(':id', nodeSelected.selected);
            var urlDeleteRoute = '{!! route("admin.menus.confirm-delete",":id") !!}'.replace(':id', nodeSelected.selected);
            ...
            $.ajax({
                ...
                success: function (returnData) {
                    ...
                    menuNepai           = menuObject.nepali_label;
                    menuSpanish           = menuObject.spanish_label;
                    ...
                    $('#id').val(menuID);
                    $('#name').val(menuName);
                    $('#nepali_label').val(menuNepai);
                    $('#spanish_label').val(menuSpanish);
                    $('#label').val(menuLabel);
...
$("#flip-lang").click(function(){
    $('#flip-lang i').toggleClass("fa-angle-double-down  fa-angle-double-up");
    $("#more-lang").slideToggle("slow");
  });
    </script>
@endsection
