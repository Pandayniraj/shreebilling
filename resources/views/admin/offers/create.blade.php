        ...
        <div class="box">
           ...
           <div class="row">
              <div class="col-md-12 col-sm-12 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="offer_title" class="form-control offer_title" placeholder="Offer Title" required="">
           ...
           <div class="row">
              <div class="col-md-12 col-sm-12 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="offer_slug" class="form-control offer_slug" placeholder="Offer Title" required="">
                    <div class="input-group-addon">
           ...
           <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-6 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="offer_price" class="form-control" placeholder="Offer Price" required="">
                    <div class="input-group-addon">
              ...
              <div class="col-md-4 col-sm-6  col-xs-6 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="available_from" class="form-control datepicker" placeholder="Available From" required="">
                    <div class="input-group-addon">
              ...
              <div class="col-md-4 col-sm-6 col-xs-6 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="available_to" class="form-control datepicker" placeholder="Available To" required="">
                    <div class="input-group-addon">
                       <a href="#"><i class="fa    fa-calendar"></i></a>
                    </div>
                 </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-6 form-group">
                 ...
                 <div class="input-group">
                    <input type="text" name="order_sequence" class="form-control" placeholder="Enter a offer squence based on priority" required="" value="{{$lastSequence + 1}}">
                    <div class="input-group-addon">
           ...
           <div class="row">
              <div class="col-md-4 col-sm-6 form-group">
                 ...
                 <input type="file" name="offer_images" required="" accept="image/*">
              </div>
              <div class="col-md-4 col-sm-6 form-group">
                 <div class="checkbox" style="margin-top: 20px;">
                    <label><input type="checkbox" value="" name="enabled">Enable</label>
                 </div>
              </div>
           </div>
           <div class="row">
