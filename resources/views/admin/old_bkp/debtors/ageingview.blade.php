        ...
        <div class='row'>
            <div class='col-md-12 d-flex'>
                <div class="wrap" style="margin-top:5px;">
                    <form method="get" action="/admin/debtors_lists/ageing">
                        <div class="filter form-inline" style="margin:0 30px 0 0;">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group" style="margin-top: 24px;">
                                    ...
                                    <a href="/admin/debtors_lists/ageing" class="btn btn-danger btn-sm"
                                    id="btn-filter-clear">
                    ...
                    <div>
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3" class="text-right" style="font-weight: bold;font-size: 20.5px">Total</td>
                                        <td style="font-weight: bold">{{ number_format($totalSum,2) }} </td>
                                        <td style="font-weight: bold">{{ $totalSum1_30 }} </td>
