...
@section('content')
     ...
     <div class='row'>
       <div class='col-md-11'>
          <div class="box">
		     <div class="box-body ">
		     	<form method="post" action="/admin/onboard/events/store" enctype="multipart/form-data">  
		     	{{ csrf_field() }}                 
		     	<h4>Onboard Events</h4>
                     ...
                     <div class="row">
	                   	<div class="col-md-8 form-group">
                            ...
                            <input type="text" name="name" placeholder="Events name" id="name" value="" class="form-control" required="" >
	                   	</div>
                     </div>
                     ...
                     <div class="row">
                      <div class="col-md-8 form-group">
                          <label class="control-label">Location</label>
                            <input type="text" name="location" placeholder="Event Location" id="location" value="" class="form-control">
                      </div>
                     </div>
                       <div class="row">
                        <div class="col-md-8 form-group">
                          <label class="control-label">Due date</label>
                            <input type="text" name="due_date" placeholder="Due date" id="due_date" value="" class="form-control datepicker" >
                      </div>
                     </div>
                       <div class="row">
                 <div class="col-md-8 form-group">
                 ...
                 <div class="col-md-8">
                  <label for="subject" class="control-label">Owner</label>
                    ...
                    <input type="hidden" class="form-control peoples" name="owner" id="ownerField" value="{{\Auth::user()->username}}" >
