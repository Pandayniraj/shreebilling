...
@section('content')
     ...
     <div class='row'>
       <div class='col-md-11'>
          <div class="box">
         <div class="box-body ">
          <form method="post" action="/admin/onboard/task/store" enctype="multipart/form-data">  
          {{ csrf_field() }}                 
                    ...
                    <div class="col-md-6 form-group">
                       ...
                       <option value="{{$te->id}}">{{ucfirst($te->name)}}(#{{$te->id}})</option>
                       @endforeach
                      </select>
                      </div>
                         <div class="col-md-6 form-group">
                          <label class="control-label"  title="Select to create from exiting template">Task Type</label><small style="color:#778AB8">&nbsp;Select to create from exiting template</small>
                            <select  class="form-control searchable" id="task_owner">
                       <option value="">Select Task </option>
                       @foreach($task_type as $tt)
                       <option value="{{$tt->id}}">{{ucfirst($tt->name)}}(#{{$tt->id}})</option>
                       @endforeach
                      </select>
                      </div>
                     </div>
                        ...
                        <div class="form-group">
                          <label class="control-label">Name</label>
                           <div class="input-group ">
                            <input type="text" name="name" placeholder="Task name" value="" class="form-control" id="tname">
                  ...
                  <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Notify Email</label>
                           <div class="input-group ">
                            <input type="email" name="notify_mail" placeholder="Notify Email" id="temail" value="" class="form-control" >
                              <div class="input-group-addon">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Notify days</label>
                           <div class="input-group ">
                            <input type="number" name="notified_before" placeholder="Notify before x days" id="tnotified_before" value="" class="form-control" >
                              <div class="input-group-addon">
                     ...
                     <div class="row">
                       ...
                       @foreach($owner as $o)
                       <option value="{{$o->id}}">{{ucfirst($o->username)}}</option>
                       @endforeach
                      </select>
                      </div>
                      </div>
                  ...
                  <div class="row">
                        ...
                        <div class="form-group">
                          <label class="control-label">Effective date</label>
                           <div class="input-group ">
                            <input type="text" name="effective_date" placeholder="Effective date" id="" value="{{date('Y-m-d')}}" class="form-control datepicker" >
                              <div class="input-group-addon">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Due date</label>
                           <div class="input-group ">
                            <input type="text" name="due_date" placeholder="Due date" id="" value="" class="form-control datepicker" >
                              <div class="input-group-addon">
                    ...
                    <input type="hidden" class="form-control peoples" name="participants" id="peoplesField" value="" >
                  </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4 form-group">
                        ...
                        Task  Description
                          ...
                          <textarea class="form-control" name="description" id="tdescription" placeholder="Task Type Description"></textarea>
                        </div>
