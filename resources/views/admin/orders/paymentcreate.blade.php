 ...
 <section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
  ...
  <div class='row'>
        <div class='col-md-12'>
            <div class="box">
                <div class="box-body">
                   <form action="/admin/payment/orders/{{$sale_id}}" method="post" id='createpayment'>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">  
                              ...
                              <div class="input-group ">
                                <input type="text" name="date" id="target_date" value="{{ old('target_date') }}" placeholder="Date" class="form-control datepicker" required="required">
...
if(source == 'lead'){
  let c = confirm('Are You Sure You Want To Make Payment and Post To Client & Invoice?');
  if(c){
    return true;
  }
  return false;
