        ...
        <div class="tab-pane active" id="tab_1">
            <div class="row">
                <div class="col-md-6">
                  ...
                  <form action="{{route('admin.payroll.remote_taxable_amount.update',$district->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="group_id" class="form-control">
                                   @foreach($categories as $index=>$val)
                                    <option value="{{$val->id}}" @if($district->group_id == $val->id) selected="selected" @endif>{{$val->group_name}}</option>
                                   @endforeach 
                            </select>
                            </div>
                             <div class="form-group">
