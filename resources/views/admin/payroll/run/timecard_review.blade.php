          ...
          <div class="box">
            <div class="box-header">
              <p class=""><?php $active_year = date('Y',strtotime($payfrequency->period_start_date)); ?>
                ...
                &nbsp; | &nbsp; <i class="fa fa-random"></i> Method: {{ isset($result) ? $entrymethod[$result[0]['time_entry_method']]:'' }} {{$timecard[0]->time_entry_method}} 
              </p>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <tr class="payrolldetails">
                ...
                <span title="Anual Leave Exceeds" class="annual_leave_warning" style=
                  ...
                  "
                  @if( isset($leavecollection['others']) && \TaskHelper::userLeave( $tc->user_id, $leavecollection['others']['id'], $active_year) > $leavecollection['others']['quota'])
                  visibility: visible;
                  @else
                  visibility: hidden;
                  @endif
