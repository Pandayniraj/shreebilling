                    ...
                    <table class="table">
                        <tbody id="more-tr">
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control stock input-sm" placeholder="Stock" value="0" readonly>
                                </td>
                                <td>
...
$(document).on('change', '.product_id', function() {
					...
					if (this.value != 'NULL') {
						...
						$.ajax({
							...
							, success: function(result) {
								...
								parentDiv.find('.stock').val(result.available);
                                parentDiv.find('.unit').find('option[value="'+result.units+'"]').prop('selected', true);
                                console.log(parentDiv.find('.unit').find('option[value="'+result.units+'"]'));
								parentDiv.find('.unit').find('option[value="'+result.units+'"]');
    ...
    calcTotal();
    	...
    	$("#addMore").on("click", function () {
            ...
            $(".multipleDiv").next('tr').find('.product_id').select2({ width: '100%' });
