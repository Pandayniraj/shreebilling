                    ...
                    <div class="content">
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                            ...
                            {!! Form::select('outlet_id', [''=>'Please Select']+$outlets, null, ['class' => 'form-control','id'=>'outlet_id']) !!}
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    {!! Form::checkbox('inventory', 'raw_material') !!}
                                    Inventory
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    {!! Form::checkbox('fixed_asset', 'fixed_asset') !!}
                                    Fixed_asset
                                </label>
                            </div>
                        </div>
