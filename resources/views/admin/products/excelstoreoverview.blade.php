<table>
	<thead>
		<tr>
			<th colspan="22" style="text-align: center; font-weight: bold; font-size: 15px; color: black; background-color: #00B050; border: 1px solid black;">
				{{ $title }}
			</th>
		</tr>
		<tr>
		...
		<tr>
			<th colspan="4" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black;">
			</th>
			<th colspan="3" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #00B0F0;">
				OPENING
			</th>
			<th colspan="3" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #FFC000;">
				RECEIPT
			</th>
			<th colspan="2" style="text-align: center; font-weight: bold; font-size: 10px; color: blackheight="25"; border: 1px solid black; background-color: #92D050;">
				RECEIPT RETURN
			</th>
			<th colspan="3" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #4BACC6;">
				ISSUE
			</th>
			<th colspan="2" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #F79646;">
				ISSUE RETURN
			</th>
			<th colspan="2" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #F2DCDB;">
				ADJUSTMENT
			</th>
			<th colspan="3" style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #FFFF00;">
				CLOSING
			</th>
		</tr>
    ...
    <tbody>
        ...
        @foreach ($records as $category=>$product)
            <tr>
                <td colspan="22" style="text-align: left; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #FFFF00;">
                {{$category}}
                </td>
            </tr>
            @php
            ...
            @foreach ($product as $name=>$title)
                ...
                @endphp
                <tr>
                    <td style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; " >
                        {{$fiscalyear}}</td>
                    <td style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; " >
                        {{$loop->index+1}}</td>
                    <td style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; "
            ...
            <tr>
                <td colspan="4" style="text-align: left; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; background-color: #FFFF00;">
                    SUB TOTAL
                </td>
                <td style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; " >
        ...
        @endforeach
        <tr>
            <td colspan="4" style="text-align: left; font-weight: bold; font-size: 12px; color: black; border: 1px solid black; background-color: #FFFF00;">
                GRAND TOTAL
            </td>
            <td style="text-align: center; font-weight: bold; font-size: 10px; color: black; border: 1px solid black; " >
