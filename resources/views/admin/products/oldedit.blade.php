                        ...
                        <div class="form-group col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    {!! Form::checkbox('inventory', 'raw_material', ($course->product_division== 'raw_material' ? 'checked':'')) !!}
                                    Inventory
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    {!! Form::checkbox('service', 'service', ($course->product_division == 'service' ? 'checked':'')) !!}
                                    Service
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="checkbox">
                                <label>
                                    ...
                                    {!! Form::checkbox('fixed_asset', 'fixed_asset', ($course->product_division == 'fixed_asset' ? ' checked' : '')) !!}
                                    Fixed_asset
                                </label>
                            </div>
                        </div>
