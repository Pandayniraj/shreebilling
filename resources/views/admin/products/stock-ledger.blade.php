                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                          <label class="control-label">Select Product</label>
                            {!! Form::select('product_id', $products, $current_product, ['class'=>'form-control searchable','placeholder'=>'Select Product']) !!}
                        </div>
    ...
    <div class="row">
        <div class="col-sm-12 std_print">
            <div class="panel panel-custom">
                ...
                <div align="center">{!! $transations->appends($_GET)->links() !!}</div>
            </div>
        </div>
    </div>
</div> 
