    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class="box-body">
                ...
                {!! Form::model( $task, ['route' => ['admin.project_task.store', $projectId ], 'method' => 'POST', 'id' => 'form_create_task', 'onSubmit'=>'return validate();', 'enctype' => 'multipart/form-data'] ) !!}
                ...
                <div class="modal-body">
                            ...
                            <label for="subject" class="col-sm-1 control-label">
                              ...
                              <div class="col-sm-11">
                                  {!! Form::text('subject', $task->subject, ['class' => 'form-control required', 'id'=>'subject','placeholder'=>'Type Task Subject', 'required'=>'required']) !!}
                              </div>
                            </div>
                    ...
                    <div class="form-group">
                        {!! Form::label('description', trans('admin/project-task/general.columns.description')) !!} *
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <label  class="col-sm-4 control-label">
                            {!! trans('admin/project-task/general.columns.percent_complete')) !!}
                          </label>
                            <span class="col-sm-8">
...
<br/><br/>
                    ...
                    <div class="col-md-6">
                       ...
                       <div class="form-group">
                            ...
                            Start Date
                              ...
                              <div class="col-sm-8">
                            {!! Form::text('start_date', $task->start_date, ['class' => 'form-control required', 'id'=>'start_date']) !!}
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            Task end Date
                              ...
                              <div class="col-sm-8">
                            {!! Form::text('end_date', $task->end_date, ['class' => 'form-control required', 'id'=>'end_date']) !!}
                        </div>
                        </div>
 <br /> <br/>
 ...
 <br /> <br />
                ...
                <div class="form-group">
                    ...
                    <a href="/admin/projects/{{ \Request::get('pid') }}" class='btn btn-default'>Close</a>
                </div>
