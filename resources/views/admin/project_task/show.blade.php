...
<div class="container">
    <div class="main-body">
        ...
        <nav aria-label="breadcrumb" class="main-breadcrumb">
            ...
            <h3 class="breadcrumb">#{!! $task->id !!}. <span id="edit_task_subject">{!! $task->subject !!}</span> </h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{ TaskHelper::getProfileImage($task->user_id) }}" class="rounded-circle" width="150" style="margin-left: 20px;">
                            <div class="mt-3">
                                <h4> {{ $task->user->first_name}} {{ $task->user->last_name}}</h4>
                                <p class="text-secondary mb-1"> {{ PayrollHelper::getDepartment($task->user->departments_id) }}</p>
                                <p class="text-muted font-size-sm">{{ PayrollHelper::getDesignation($task->user->designations_id) }}</p>
                                <a class="btn btn-success btn-xs" href="javascript:window.open('','_self').close()" type="button">{{ trans('admin/projects/general.button.save_close') }}</a>
                                <a class="btn btn-primary  btn-xs" href="{!! route('admin.project_task.edit', $task->id) !!}">{{ trans('admin/projects/general.button.edit') }}</a>
                                @if ( $task->isDeletable() )
                                <a class="btn btn-danger  btn-xs delete-task" href="#" data-toggle="modal" data-target="#modal_dialog" title="{{ trans('general.button.delete') }}">{{ trans('admin/projects/general.button.delete') }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-8">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <b>{{ trans('admin/projects/general.columns.status') }}</b>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <b>{{ trans('admin/projects/general.columns.description') }}</b>
                            </div>
                            <div class="col-md-9 text-secondary">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <b>{{ trans('admin/projects/general.columns.people') }}</b>
                            </div>
                            <div class="col-md-9 text-secondary">
                                <span class="txtfield">
                                    <ul id="peoples"></ul>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="d-flex align-items-center mb-3"><i class="fa  fa-film"></i>
                    ...
                    <div class="col-md-6" style="margin: 0;padding: 3;margin-left: -8px;margin-top: -3px;">
                        <div class="card">
                            <div class="card-body">
                                <form action="/admin/post_comment" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="img-push">
                                        <div class="col-md-9">
                                            <textarea type="text" style="width:90%; float: left;" class="form-control input-sm" name="comment_text" placeholder="{{ trans('admin/projects/general.placeholder.comment_post') }}"></textarea>
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" style="padding: 5px; margin-left: 3px;" name="submit_comment" class="btn btn-info btn-xs">{{ trans('admin/projects/general.button.send') }}</button>
                                        </div>
                                ...
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-info clearfix">
                                        <span class="direct-chat-name pull-left"><strong>{{ mb_substr($cv->user->first_name,0,3) }} {{ $cv->user->first_name }}
                                                #({{ $cv->user->id }})</strong></span>
                                        <span class="direct-chat-timestamp pull-right"> {{ date('dS M y', strtotime($cv->created_at)) }}</span>
                                    </div>
                                    <!-- /.direct-chat-info -->
                                    <img class="direct-chat-img" src="{{$cv->user->avatar}}" alt="message user image">
                                    <!-- /.direct-chat-img -->
