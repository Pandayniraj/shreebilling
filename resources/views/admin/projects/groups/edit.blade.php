...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body">
              <form action="{{ route('admin.projects.group.edit', $group->id) }}" method="POST" role="form">
                {{ csrf_field() }}
                      <div class="row">
                        <div class="col-md-6 form-group">
                            <label class="control-label">Group Name</label>
                            <div class="input-group">
                                <input type="text"  class="form-control" required="" placeholder="Group name should be unique to each project" value="{{ $group->name }}" readonly="">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-6 form-group">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="enabled" value="" @if($group->enabled) checked="" 
                                    @endif>
                                    Enabled
                                </label>
                            </div>
