 ...
 <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive">
				...
				<a href="{{ route('admin.salary-voucher.add') }}" class="btn btn-primary btn-sm pull-right" style="margin-bottom: 10px;">Create</a>
              ...
              <table class="table table-bordered" style="border: 1px solid #c4b8b8;">
				...
				<tbody id='entry_list'>
				   @foreach($entries as $entry)
						<tr><td><a href="/admin/salary-voucher/show/{{$entry->id}}?fiscal_year={{\Session::get('selected_fiscal_year')}}">{{$entry->number}}</a></td>
							...
							<td>
								...
								<span class="label {{isset($entry->tagname->color)?$entry->tagname->color:'label-warning'}}">{{isset($entry->tagname->title)?$entry->tagname->title:''}}</span>
							...
							<td>
								...
								<a href="/admin/salary-voucher/{{$entry->id}}/edit" class="no-hover" title="Edit" escape="false"><i class="fa fa-edit"></i></a>
								<span class="link-pad"></span>
