            ...
            <div class="box-body">
                    ...
                    <table class="table">
                        <tbody id="more-tr">
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control price" name="unit_price_new[]" placeholder="Price" value="@if(isset($orderDetail->unit_price)){{ $orderDetail->unit_price }}@endif" required="required">
                                </td>
                                <td>
                        ...
                        <tbody id="Custom-more-tr">
                            <tr>
                              <td>
                                ...
                                <td>
                                    <input type="text" class="form-control price" name="custom_items_rate_new[]" placeholder="Price" value="@if(isset($orderDetail->unit_price)){{ $orderDetail->unit_price }}@endif" required="required">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" class="form-control total" name="custom_item_amount_new[]" placeholder="Total" value="@if(isset($orderDetail->total)){{ $orderDetail->total }}@endif" readonly="readonly" style="float:left; width:80%;">
                                    <a href="javascript::void(1);" style="width: 10%;">
                                        <i class="remove-this btn btn-xs btn-danger icon fa fa-trash deletable" style="float: right; color: #fff;"></i>
                                    </a>
                                </td>
                ...
                <div class="col-md-12">
                    <div class="panel panel-bordered">
                      <form method="post" action="/admin/sales/{{$order->order_no}}">
                          {{ csrf_field() }}
                            ...
                            <div class="panel-body">
                              ...
                              <div class="col-md-3" style="margin-bottom:;">
                                ...
                                <table class="table">
                                    ...
                                    <input type="hidden" value="{{$order->order_reference_id}}" name="order_reference_id" id="order_reference_id">
