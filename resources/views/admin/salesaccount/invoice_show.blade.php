      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <a href="/admin/sales/print/{{ $orderNo.'/'.$invoiceNo }}" target="_blank" class="btn btn-default pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>Print</a>

            <a href="/admin/mail/invoice/{{$orderNo.'/'.$invoiceNo}}/show-mailmodal" class="btn btn-default pull-right"   style="margin-right: 5px;">  <i class="fa fa-envelope"></i> Send Email</a>

            <a href="/admin/sales/generatePDF/{{ $orderNo.'/'.$invoiceNo }}">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          <address>
            ...
            Generated by: {{ $saleDataInvoice->user->first_name}} {{ $ord->user->last_name}}
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <b>{{ ucwords(str_replace("_", " ", ucfirst($saleDataInvoice->order_type)))}} #{{ $ord->id }}</b><br>
