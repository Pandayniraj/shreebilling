...
<html>
  <head>
    <meta charset="UTF-8">
    <title>{{ env('APP_COMPANY')}} | Quotation</title>
...
<body onload="window.print();" cz-shortcut-listen="true" class="skin-blue sidebar-mini">
  ...
  <div class='wrapper'>
      ...
      <section class="invoice">
        ...
        <!-- /.row -->
        Thank you for choosing {{ env('APP_COMPANY') }}. Your Quotaion is detailed below. If you find errors or desire certain changes, please contact us.
        <hr/>
        <!-- Table row -->
        <div class="row">
