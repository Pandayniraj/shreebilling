        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body wrap-modal wrap">
                    ...
                    <form class="form-horizontal" action="/admin/update_my_attendance" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control fixdatetimepicker" placeholder="Enter the time to fix" value="{{$date.' '.date("H:i:s")}}" name="time">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" placeholder="Enter the reason" name="reason"></textarea>
                            </div>
