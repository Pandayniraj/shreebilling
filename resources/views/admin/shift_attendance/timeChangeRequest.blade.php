                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ date('D M h:i a', strtotime($hv->actual_time)) }}</td>
                            <td>{{ date('D M h:i a', strtotime($hv->requested_time)) }}</td>
                            <td>
                                @if($hv->status == 1)
                            ...
                            <td class="hidden-print"><a href="/admin/timechange_request_modal/{{ $hv->id }}" class="btn btn-primary btn-xs" title="Edit"data-toggle="modal" data-target="#modal_dialog"><span class="fa fa-edit"></span></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
