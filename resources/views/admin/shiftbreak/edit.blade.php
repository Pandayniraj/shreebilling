...
<link href="/bower_components/admin-lte/select2/css/select2.min.css" rel="stylesheet" />
 ...
 <div class='row'>
       <div class='col-md-12'>
          <div class="box">
		     <div class="box-body ">
		     	<form method="post" action="{{route('admin.shiftsBreaks.edit',$shiftbreak->id)}}"  class="form-horizontal">  
		     	{{ csrf_field() }}
		     ...
		     <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                  	{!! Form::select('shift_id',$shifts,$shiftbreak->shift_id,['class'=>'form-control searchable','placeholder'=>'Select Shift']) !!}
...
<div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                    <input type="text" name="name" placeholder="Break Name" class="form-control" value="{{$shiftbreak->name}}">
                  <div class="input-group-addon">
                ...
                <div class="col-sm-9">
                  ...
                  name="icon" required="" readonly="" id='icons_input' value="{{$shiftbreak->icon}}">
                  <div class="input-group-addon">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                  	<input type="text" name="start_time" placeholder="Start Time" class="form-control datepicker" value="{{$shiftbreak->start_time}}">
                  <div class="input-group-addon">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                  	<input type="text" name="end_time" placeholder="End Time" class="form-control datepicker"  value="{{$shiftbreak->end_time}}">
                  <div class="input-group-addon">
                    <a href="#" ><i class="fa fa-calendar"></i></a>
                    </div>
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group">
                  	{!! Form::select('pay_type',array(''=>'Not Set','paid' => 'Paid', 'unpaid' => 'Unpaid'),  $shiftbreak->pay_type ,['class'=>'form-control searchable']) !!}
                  <div class="input-group-addon">
