                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <label>Purchase bill id</label>
                                          <input type="text" class="form-control pull-right " name="purchase_bill_id" value="{{$purchasereturn->purchase_bill_id}}" id="purchase_bill_no" required="">
                                     </div>
                                     <div class="col-md-3">
                                        <label>Purchase bill No</label>
                                          <input type="text" class="form-control pull-right " name="purchase_bill_no" value="{{sprintf('%08d',$purchasereturn->purchase_bill_no)}}" id="pur_billno" required="" readonly>
                                     </div>
