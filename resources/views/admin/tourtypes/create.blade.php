...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body ">
                <form method="post" action="{{route('admin.tours.types.settings.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-4 col-sm-12 form-group">
                            <label class="control-label">Name</label>
                            <div class="input-group">
                                <input type="text" name="sett_name" class="form-control" placeholder="Name" required="">
                        ...
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="sett_type" class="form-control" placeholder="Type" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa   fa-database"></i></a>
                                </div>
                            </div>
