...
<div class="col-md-3" style="float: none; margin: 0 auto;">
 <h2 class="login-box-msg"> {{ env('APP_NAME')}}</h2>    
    <p style="font-size: 16.5px" class="login-box-msg">Enter your information to register</p>
        ...
        {!! link_to_route('login', 'Sign in', [], ['class' => "text-center"]) !!} |
      <a class="btn btn-link" href="{{ route('password.request') }}">Forgot My Password</a>
