    ...
    <div class='row'>
        <div class='col-md-8'>
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Audit Activities</h3>
                            ...
                            <tbody>
                                @foreach($audits as $audit)
                                    <tr>
                                        ...
                                        <td>{{ $audit->message }}</td>
                                        <td>{{ date('dS M y', strtotime($audit->created_at)) }}</td>
                                        <td>
            ...
            <div class="box box-primary">
                ...
                <td><h4><a href="/admin/announcements/show/{{ $av->announcements_id }}" data-toggle="modal" data-target="#announcement_show" data-placement="top">{{ $av->title }}</a></h4></td>
                        <td>{{ date('dS M', strtotime($av->start_date)) }}
                              <?php
                                        ...
                                        $d = $cal->eng_to_nep($a,$b,$c);
                                         ...
                                         $nepali_date = $d['day'].', '.$d['date'].' '.$d['nmonth'] .', '.$d['year'];
                                        ?>
                         ...
                         <small>/ {!! $nepali_date !!}</small>
                            ...
                            <td>{{ date('dS M', strtotime($av->end_date)) }}
                        ...
                        <td class="hidden-print">
                            ...
                            <a href="/admin/announcements/edit/{{ $av->announcements_id }}" class="btn btn-primary btn-xs" data-toggle="modal" data-placement="top" data-target="#announcement_modal" @if(!$av->isEditable()) disabled @endif><span class="fa fa-edit"></span></a>
        ...
        <div class='col-md-4'>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Items Inventory</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    </div>
