<table style="border: 1px solid; text-align:center">
    ...
    <tr>
        <th colspan="16" style="text-align:center; font-size:14px font-weight:800;">Daily Dispatch Sheet and Stock of {{\App\Helpers\TaskHelper::getNepaliDate(date('Y-m-d'))}}</th>
    </tr>    
