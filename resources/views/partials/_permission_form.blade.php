        ...
        <div class="tab-pane" id="tab_routes">
            <div class="form-group">
                ...
                <div class="input-group select2-bootstrap-append">
                    {!! Form::select('route_search[]', [], null, ['class' => 'form-control', 'id' => 'route_search',  'style' => "width: 100%",'multiple'=>'multiple']) !!}
                    <span class="input-group-btn">
                        <button class="btn btn-default" id="btn-add-route" type="button">
                            <span class="fa fa-plus-square"></span>
                        </button>
                         <button class="btn btn-default"  type="button" title="Clear Search" onclick="clearsearch();">
...
function clearsearch(){
    let c = confirm("Are you sure you want to clear");
    if(!c) return false;
    $('#route_search').select2('val', '');
    return 0;
}
</script>